<?php
    ...
    add_form_template_field($template['fields'], 'Password', 'password', $FIELD_TYPES['TEXT'], true);
    add_form_template_field($template['fields'], 'Description', 'description', $FIELD_TYPES['TEXT_AREA'], false);
